/**
 * Notification Service - Handles browser push notifications and in-app notifications
 */
class NotificationService {
    ...
    showBrowserNotification(title, options = {}) {
        ...
        const notification = new Notification(title, {
            icon: options.icon || '/customer/images/logo.png',
            badge: '/customer/images/logo.png',
            body: options.body || '',
