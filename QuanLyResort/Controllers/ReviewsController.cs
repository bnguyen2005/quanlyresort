...
public class ReviewsController : ControllerBase
{
    ...
    /// <summary>
    /// L?y danh sách t?t c? dánh giá (công khai)
    ...
    /// <summary>
    /// T?o dánh giá m?i (yêu c?u dang nh?p)
    /// POST /api/reviews
    /// </summary>
    [HttpPost]
    ...
    public async Task<IActionResult> CreateReview([FromBody] CreateReviewRequest request)
    {
        ...
        if (request.RoomId.HasValue)
        {
            ...
            {
                return BadRequest(new { message = "B?n dã dánh giá phòng này r?i. B?n có th? ch?nh s?a dánh giá c?a mình." });
            }
        }
        ...
        return CreatedAtAction(nameof(GetReviewById), new { id = review.ReviewId }, new
        {
            ...
            review.Comment,
            review.CreatedAt,
            message = "Ðánh giá c?a b?n dã du?c g?i thành công!"
        });
    }

    /// <summary>
    /// Admin ph?n h?i dánh giá
    ...
    /// <summary>
    /// Ki?m tra customer dã t?ng check-out phòng này chua
    ...
    /// <summary>
    /// L?y danh sách phòng customer dã check-out (có th? dánh giá)
    ...
    /// <summary>
    /// L?y t?t c? dánh giá cho admin (bao g?m c? chua approved)
        ...
        [FromQuery] DateTime? toDate = null)
    {
        ...
        catch (Exception ex)
        {
            ...
            return StatusCode(500, new { message = "L?i khi t?i dánh giá", error = ex.Message });
        }
    }

    /// <summary>
    /// C?p nh?t tr?ng thái dánh giá (approve/hide/delete)
