...
public class EmployeeManagementController : ControllerBase
{
    ...
    public async Task<IActionResult> DeleteEmployee(int id)
    {
        ...
        // X? lý foreign key constraint: Set EmployeeId = null trong Users tru?c
    ...
    public IActionResult GetDepartments()
    {
        var departments = new[]
        {
            new { value = "Management", label = "Ban Giám Ð?c", description = "Qu?n lý c?p cao" },
            new { value = "Business", label = "Kinh Doanh", description = "Kinh doanh & marketing" },
            new { value = "FrontDesk", label = "L? Tân", description = "Ti?p dón khách" },
            new { value = "Finance", label = "Tài Chính", description = "K? toán & thu ngân" },
            new { value = "Operations", label = "V?n Hành", description = "Kho & logistics" },
            new { value = "Housekeeping", label = "Bu?ng Phòng", description = "D?n d?p & v? sinh" },
            new { value = "Maintenance", label = "K? Thu?t", description = "S?a ch?a & b?o trì" },
            new { value = "Kitchen", label = "B?p", description = "Nhà hàng & ?m th?c" },
